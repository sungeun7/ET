...
export const MAP_TEMPLATES = [
  {
    ...
    playerSpawns: [[1, 7], [2, 8], [1, 8], [2, 7], [0, 7]],
  ...
  },
  {
    ...
    playerSpawns: [[1, 4], [2, 5], [1, 6], [2, 3], [2, 4]],
  ...
  },
  {
    ...
    playerSpawns: [[0, 9], [1, 9], [2, 9], [1, 8], [3, 9]],
  ...
  },
  {
    ...
    playerSpawns: [[1, 8], [2, 7], [0, 7], [2, 9], [2, 8]],
  ...
  },
  {
    ...
    playerSpawns: [[1, 4], [2, 5], [1, 5], [2, 3], [2, 4]],
  ...
  },
  {
    ...
    playerSpawns: [[1, 2], [2, 1], [1, 7], [2, 8], [2, 2]],
  ...
  },
  {
    ...
    playerSpawns: [[1, 1], [2, 0], [1, 8], [2, 9], [2, 1]],
  ...
  },
  {
    ...
    playerSpawns: [[3, 9], [4, 8], [5, 9], [4, 9], [2, 9]],
  ...
  },
  {
    ...
    playerSpawns: [[1, 9], [2, 8], [3, 9], [2, 9], [0, 9]],
  ...
  },
  {
    ...
    playerSpawns: [[1, 4], [2, 4], [0, 4], [3, 4], [2, 5]],
...
const ENEMY_NAMES = {
  ...
  cleric: ['타락 사제', '흑성 수도사', '저주 치유사', '암흑 주교', '허무의 성자'],
};
...
const PLAYER_ROSTER = [
  { id: 'p1', name: '레온', classId: 'knight' },
  { id: 'p2', name: '아린', classId: 'archer' },
  { id: 'p3', name: '미라', classId: 'mage' },
  { id: 'p4', name: '카엘', classId: 'fighter' },
  { id: 'p5', name: '엘라', classId: 'cleric' },
];
